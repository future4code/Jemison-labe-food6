...
const Footer = ({feed, cart, user}) => {
    ...
    return (
        <Box sx={{ position: "fixed", bottom: '0', boxShadow: '0px -1px 2px 0px rgba(0,0,0,0.3)', bgcolor: '#fefefe', width: '100vw', height: '49px', display: 'flex', alignItems: 'center', mt: 2 }}>
            <Box onClick={() => goToFeed(navigate)} sx={{ width: 'calc(100% / 3)', display: 'flex', flexGrow: 1, justifyContent: 'center' }}>
                <SvgIcon sx={{ fontSize: '30px', color: feed ? '#e86e5a' : '#b8b8b8' }} xmlns="http://www.w3.org/2000/svg" width="27" height="27" viewBox="0 0 27 27">
                    <g>
